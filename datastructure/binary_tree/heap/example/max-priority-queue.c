...
//reference: https://www.codesdope.com/blog/article/priority-queue-using-heap/
...
//part1) search from heap(in array form, therefore return index of an array)
...
//part2) heapify(insert data into heap)
...
void insert(int A[], int key) {
  heap_size++;
  A[heap_size] = -1*INF; //-infinity로 초기화
